...
let CommentsController = class CommentsController {
    ...
    create(leadId, createCommentDto) {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Add a comment to a lead' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all comments for a lead' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns comments list' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Lead not found' }),
    __param(0, (0, common_1.Param)('leadId')),
    __metadata("design:type", Function),
...
exports.CommentsController = CommentsController = __decorate([
    ...
    (0, common_1.Controller)('leads/:leadId/comments'),
